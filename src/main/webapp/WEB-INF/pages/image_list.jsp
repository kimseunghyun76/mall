...
<html>
	<head>
		...
		function submitButton(index) 
		{
			var gForm = document.grtForm;
		 	...
		 	{
			 	gForm.target = "Getting Image Information";
		 		gForm.action = "./GetImageInfo";	
		 	}
		 	rForm.submit();
		 	return;
		}
	...
	<body>
		...
		<h1>이미지승인</h1>
		<form name="grtForm" method="post" action="./GetImageInfo">
		<table align="center" cellspacing="0" style="width:100%">
		    <tr>
		    	<td align="right" colspan=2>
			    	<input type="button" name="ok" value="승인" onclick="javascript:submitButton(1);" <%=optionStr%>>
			    	<input type="button" name="ng" value="반려 " onclick="javascript:submitButton(2);" <%=optionStr%>>
		       		...
		       		<c:choose>
			       		<c:when test="${currentPage eq page}">
			            	<tr>
				                ...
				                <td>${image.groupName} / ${image.shopName} / ${image.userName} / ${image.userId} / ${image.tel} / ${image.section} / ${image.imageUrl}</td>
